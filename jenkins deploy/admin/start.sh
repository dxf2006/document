...
#
SKY_AGENT=" -javaagent:/usr/local/skywalking-agent/agent/skywalking-agent.jar -Dskywalking.agent.service_name=$SERVICE_NAME "
...
nohup java $JAVA_OPTS $SKY_AGENT -jar $PATH_TO_JAR $>/dev/null 2>&1 &
